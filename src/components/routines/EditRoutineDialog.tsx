...
interface EditRoutineDialogProps {
  ...
  onEditRoutine: (id: string, updatedRoutine: z.infer<typeof formSchema> & { exercises: number; isTemplate: boolean }) => void;
}
...
export const EditRoutineDialog = ({ open, onOpenChange, routine, onEditRoutine }: EditRoutineDialogProps) => {
